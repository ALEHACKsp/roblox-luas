wait(2)
-- made by Unixian#4669, please credit me if you're taking my amazing code!!
...
blue_label.Text = "Non-replicated (Other people can't see)"
...
red_label.Text = "Replicated (Other people can see)"
...
title.TextSize = 18
title.Text = "C00lgui reb0rn by unixian" -- DO NOT REMOVE/CHANGE!!!!!
...
-- button shit (thx codinghelpers and friendz for helping me paste)
